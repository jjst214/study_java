...
public class Lotte {
	...
	public static void main(String[] args) {
		...
		BigBurger b1 = new BigBurger(5000, "맛있는빅버거");
		...
		int setPrice1 = b1.getPrice() + c1.getPrice() + f1.getPrice();
		int setPrice2 = set2.getBigBurger().getPrice() + set2.getCoke().getPrice() + set2.getFrenchfried().getPrice();
		System.out.println("set1의 합계는 " + setPrice(set1) + "입니다.");
		System.out.println("set2의 합계는 " + setPrice(set2) + "입니다.");
	}
	
	static int setPrice(BigBurgerSet bigset) {
		int setPrice = bigset.getBigBurger().getPrice() + bigset.getCoke().getPrice() + bigset.getFrenchfried().getPrice();
		return setPrice;
	}
}
